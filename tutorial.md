...
Counter Strike 2 (CS2) is the sequel to the popular online tactical shooter Counter Strike: Global Offensive (CS:GO).  Players can join either the terrorist or counter-terrorist teams.  On most maps the terrorist's objective is to take over a bombsite and plant the bomb before time runs out.  Counter-terrorists are there to make sure that doesn't happen.  In the hostage game mode, the counter-terrorists must rescue hostages from the terrorist side of the map and bring them back to safety.  Team coordination and communication are crucial to success, as is having a deep knowledge of map layouts / angles of attack.   
